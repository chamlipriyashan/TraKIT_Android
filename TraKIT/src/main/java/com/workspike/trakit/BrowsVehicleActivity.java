...
public class BrowsVehicleActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    // Log tag
   ...
   // private static final String url = "http://api.androidhive.info/json/movies.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browsvehicles);
        listView = (ListView) findViewById(R.id.list);
        adapter = new VehicleListAdapter(this, vehicleList);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(this);
        pDialog = new ProgressDialog(BrowsVehicleActivity.this);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                Toast toast = Toast.makeText(BrowsVehicleActivity.this,
                                        "No Network Detected",
                                        Toast.LENGTH_SHORT);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent vehicle_intent = new Intent(BrowsVehicleActivity.this,
